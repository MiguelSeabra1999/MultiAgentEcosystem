...
public class MoveActuator : MonoBehaviour
{
    ...
    private void FixedUpdate() {
        if(currentDir.magnitude > 0.01f)
        {
            ...
            Debug.DrawRay(transform.position,(new Vector3(currentDir.x,0,currentDir.y)).normalized * genome.senseRadius, Color.blue);
        }
    }
    ...
    public void SetMovement(Vector2 move)
    {
        ...
        rb.velocity = new Vector3(move.x,0,move.y) * genome.speed;
    ...
    private void AdjustFacingDirection(Vector2 dir)
    {
